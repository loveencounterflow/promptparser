  ...
  get_types = function() {
    ...
    types.declare({
      ...
      fm_constructor_cfg: {
        ...
        create: function(db_path, datasource_path, trash_db = false) {
          ...
          return {db_path, has_db_path, has_db, datasource_path, has_datasource_path, has_datasource, auto_populate_db, trash_db};
        }
      },
      //.......................................................................................................
      ...
      pfr_constructor_cfg: {
        ...
        create: function(cmd, flags, upstream_cfg = null) {
          var R, datasource_path, db_path, has_datasource_path, has_db, has_db_path;
          db_path = flags.db;
          has_db_path = db_path != null;
          has_db = has_db_path;
