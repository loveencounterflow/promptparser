(function() {
  'use strict';
  var DATOM, GUY, Interlex, Syntax, alert, compose, debug, echo, first, help, info, inspect, last, lets, log, new_datom, new_prompt_lexer, plain, praise, rpr, stamp, urge, warn, whisper;
  ...
  (() => {    //===========================================================================================================
    ...
    for (i = 0, len = prompts.length; i < len; i++) {
      ...
      ref = (new_prompt_lexer()).walk(prompt);
      for (d of ref) {
