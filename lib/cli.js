(async function() {
  'use strict';
  var Failure, GUY, MIXA, Mixa, Promptparser_cli, WG, alert, color, debug, echo, get_types, help, hide, info, inspect, log, plain, praise, return_error, rpr, run, types, urge, warn, whisper;
...
/* TAINT should call `create` */      return null;
    ...
    //---------------------------------------------------------------------------------------------------------
    cmd_help() {
      var cmd, cmd_def, cmds, description, expect, flag, flag_def, flags, i, j, len, len1, ref, ref1;
      if (this.error != null) {
        warn('Ω___3', GUY.trm.reverse(` ${this.error.tag}: ${this.error.message} `));
      }
      //.......................................................................................................
  ...
  Promptparser_cli = (function() {
    ...
    class Promptparser_cli extends Mixa {
      ...
      //   return null
        ...
        //---------------------------------------------------------------------------------------------------------
      cmd_build() {
        help('Ω___7', "cmd_build", this.flags);
        // pfr = @_new_prompt_file_reader()
        return null;
      }
