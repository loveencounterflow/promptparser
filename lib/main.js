(async function() {
  'use strict';
  var GUY, Image_walker, Journal_walker, Prompt_db, alert, debug, echo, help, info, inspect, log, plain, pluck, praise, reverse, rpr, urge, warn, whisper;
  ...
  Prompt_db = class Prompt_db {
    ...
    constructor(cfg) {
      ...
      this.cfg = this.types.create.prompt_db.cfg(cfg);
      this.trash_db_if_necessary();
      hide(this, 'db', pluck(this.cfg, 'db'));
