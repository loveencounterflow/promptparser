(async function() {
  ...
  */
  ...
  ;`);
      ...
      //---------------------------------------------------------------------------------------------------------
      _populate_db() {
        var line_count, nonmatching_line_count, read_prompt_count, unique_row_ids, written_prompt_count;
        ...
        //.......................................................................................................
        this._db(() => {
          var TMP_result, record, ref, ref1, row;
          ...
          for (row of ref) {
            ...
            for (record of ref1) {
              ...
              //.................................................................................................
              TMP_result = this.insert_into[record.table](record.fields);
              if (record.table === 'prompts') {
            ...
            if (written_prompt_count >= this.cfg.flags.max_count) {
              whisper('Ω__13', "Prompt_file_reader::_populate_db", GUY.trm.white(`stopping because prompt count exceeds \`--max-count\` (${format_nr(this.cfg.flags.max_count)})`));
              break;
            }
          }
          return null;
