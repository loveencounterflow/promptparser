(async function() {
  'use strict';
  var $, DATOM, DBay, FS, File_mirror, GUY, Interlex, PATH, Pipeline, Prompt_file_reader, Prompt_parser, SQL, Syntax, Transformer, U, WG, alert, build_file_db, compose, debug, demo_prompts, echo, end_of_line, format_nr, get_types, help, hide, info, inspect, lets, log, new_datom, new_prompt_lexer, plain, praise, rpr, stamp, start_of_line, transforms, trash, types, urge, warn, whisper,
  ...
  */
  ...
  ;`);
      ...
      //---------------------------------------------------------------------------------------------------------
      _populate_db() {
        var line_count, nonmatching_line_count, read_prompt_count, unique_row_ids, unsampled_line_count, written_prompt_count;
        ...
        this._db(() => {
          ...
          for (row of ref) {
            ...
            if (modulo(line_count, 1e3) === 0) {
              whisper('Ω__11', "Prompt_file_reader::_populate_db", GUY.trm.white(`line count: ${format_nr(line_count)}`));
            }
            //...................................................................................................
            /* --SAMPLE */
            ...
            if (written_prompt_count >= this.cfg.flags.max_count) {
              whisper('Ω__13', "Prompt_file_reader::_populate_db", GUY.trm.white(`stopping because prompt count exceeds max prompt count of ${format_nr(this.cfg.flags.max_count)} prompts`));
              break;
            }
          }
          return null;
        ...
        whisper('Ω__15', "Prompt_file_reader::_populate_db", GUY.trm.white(`line count:              ${format_nr(line_count)}`));
        //.......................................................................................................
        if (unsampled_line_count > 0) {
          whisper('Ω__16', "Prompt_file_reader::_populate_db", GUY.trm.white(`'unsampled' line count:  ${format_nr(unsampled_line_count)}`));
        }
        //.......................................................................................................
        if (nonmatching_line_count > 0) {
          whisper('Ω__16', "Prompt_file_reader::_populate_db", GUY.trm.white(`non-matching line count: ${format_nr(nonmatching_line_count)}`));
        }
        //.......................................................................................................
        whisper('Ω__17', "Prompt_file_reader::_populate_db", GUY.trm.white(`inserted ${format_nr(written_prompt_count)} rows into DB at ${this.cfg.db_path}`));
        //.......................................................................................................
        return null;
      }
