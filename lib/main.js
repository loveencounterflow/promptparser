  ...
  */
      ...
      _populate_db() {
        ...
        try {
          ...
          if ((ref = error.code) === 'ENOENT' || ref === 'EACCES' || ref === 'EPERM') {
            whisper('Ω__15', "File_mirror::_populate_db", U.color.bad(error.message));
            process.exit(111);
          }
          throw error;
        }
  ...
  ;`);
      ...
      _populate_db() {
        ...
        this._db(() => {
          ...
          for (row of ref) {
            ...
            if (modulo(line_count, 1e3) === 0) {
              whisper('Ω__12', "Prompt_file_reader::_populate_db", GUY.trm.white(`line count: ${U.format_nr(line_count, 8)}`));
            }
            //...................................................................................................
            /* EXCLUDE EMPTY LINES */
            if (/^\s*$/.test(row.line)) {
            ...
            if (written_prompt_count >= this.cfg.flags.max_count) {
              whisper('Ω__13', "Prompt_file_reader::_populate_db", GUY.trm.white(`stopping because prompt count exceeds max prompt count of ${U.format_nr(this.cfg.flags.max_count)} prompts`));
              break;
            }
          }
          return null;
        ...
        //.......................................................................................................
        /* TAINT use API */        whisper('Ω__14');
        whisper('Ω__15', "Prompt_file_reader::_populate_db", GUY.trm.white(`line count:              +${U.format_nr(line_count, 12)}`));
        //.......................................................................................................
        if (blank_line_count > 0) {
          whisper('Ω__16', "Prompt_file_reader::_populate_db", GUY.trm.white(`blank line count:        –${U.format_nr(blank_line_count, 12)}`));
        }
        //.......................................................................................................
        ...
        if (nonmatching_line_count > 0) {
          whisper('Ω__17', "Prompt_file_reader::_populate_db", GUY.trm.white(`non-matching line count: –${U.format_nr(nonmatching_line_count, 12)}`));
        }
        //.......................................................................................................
        whisper('Ω__18', "Prompt_file_reader::_populate_db", GUY.trm.white(`inserted ${U.format_nr(written_prompt_count)} rows into DB at ${this.cfg.db_path}`));
        //.......................................................................................................
        return null;
      }
