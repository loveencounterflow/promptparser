(async function() {
  'use strict';
  var $, DATOM, DBay, FS, GUY, Interlex, PATH, Pipeline, Prompt_file_db, Prompt_file_reader, Prompt_parser, SQL, Syntax, Transformer, U, alert, build_file_db, compose, debug, demo_file_as_virtual_table, echo, help, info, inspect, lets, log, new_datom, new_prompt_lexer, plain, praise, rpr, stamp, transforms, urge, warn, whisper;
  ...
  //===========================================================================================================
  Prompt_file_db = class Prompt_file_db {
    //---------------------------------------------------------------------------------------------------------
    constructor(path) {
      this._db = new DBay({path});
      this._prepare();
      //.......................................................................................................
      if (U.db_has_all_table_names(this._db)) { // , 'contents_of_readme', 'contents_of_prompts'
  ...
  //===========================================================================================================
  module.exports = {new_prompt_lexer, Prompt_file_db, Prompt_file_reader};
