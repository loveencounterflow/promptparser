(async function() {
  'use strict';
  var GUY, Image_walker, Journal_walker, NN, alert, debug, echo, help, info, inspect, log, plain, praise, reverse, rpr, urge, warn, whisper;
  ...
  ;`);
      ...
      //---------------------------------------------------------------------------------------------------------
      _populate_db() {
        return whisper('Ω___2', "Prompt_file_reader::_populate_db");
      }
