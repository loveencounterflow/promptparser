  ...
  */
  ...
  ;`);
      ...
      _populate_db() {
        ...
        this._db(() => {
          ...
          for (row of ref) {
            ...
            if (written_prompt_count >= this.cfg.flags.max_count) {
              whisper('Ω__12', "Prompt_file_reader::_populate_db", GUY.trm.white(`stopping because prompt count exceeds max prompt count of ${format_nr(this.cfg.flags.max_count)} prompts`));
              break;
            }
          }
          return null;
        ...
        //.......................................................................................................
        /* TAINT use API */        whisper('Ω__13');
        whisper('Ω__14', "Prompt_file_reader::_populate_db", GUY.trm.white(`line count:              ${format_nr(line_count)}`));
        //.......................................................................................................
        if (unsampled_line_count > 0) {
          whisper('Ω__15', "Prompt_file_reader::_populate_db", GUY.trm.white(`'unsampled' line count:  ${format_nr(unsampled_line_count)}`));
        }
        //.......................................................................................................
