(async function() {
  'use strict';
  var DATOM, DBay, GUY, Image_walker, Journal_walker, Prompt_db, SQL, alert, cmd, debug, echo, flags, get_types, help, hide, info, inspect, lets, log, new_datom, plain, pluck, praise, reverse, rpr, run_image_walker, run_journal_walker, stamp, urge, warn, whisper;
