(async function() {
  'use strict';
  var $, DATOM, DBay, FS, GUY, Interlex, PATH, Pipeline, Production_iterator, Prompt_file_reader, Prompt_parser, SQL, Syntax, Transformer, U, WG, alert, compose, debug, echo, end_of_line, get_types, help, hide, info, inspect, lets, log, new_datom, new_prompt_lexer, plain, praise, rpr, stamp, start_of_line, transforms, trash, types, urge, warn, whisper,
