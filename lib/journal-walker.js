      ...
      * [Symbol.iterator]() {
        ...
        for (row of ref) {
          ...
          if (modulo(line_count, 1e3) === 0) {
            whisper('Ω___6', "Prompt_file_reader::_populate_db", GUY.trm.white(`line count: ${U.format_nr(line_count, 8)}`));
          }
          //.....................................................................................................
          /* EXCLUDE EMPTY LINES */
          if (/^\s*$/.test(row.line)) {
          ...
          if (written_prompt_count >= this.cfg.flags.max_count) {
            whisper('Ω___7', "Prompt_file_reader::_populate_db", GUY.trm.white(`stopping because prompt count exceeds max prompt count of ${U.format_nr(this.cfg.flags.max_count)} prompts`));
            break;
          }
        }
        //.......................................................................................................
        whisper('Ω___8');
        whisper('Ω___9', "Prompt_file_reader::_populate_db", GUY.trm.white(`line count:                    +${U.format_nr(line_count, 12)}`));
        //.......................................................................................................
        whisper('Ω__10', "Prompt_file_reader::_populate_db", GUY.trm.white(`blank line count:              –${U.format_nr(blank_line_count, 12)}`));
        //.......................................................................................................
        whisper('Ω__11', "Prompt_file_reader::_populate_db", GUY.trm.white(`'unsampled' line count:        –${U.format_nr(unsampled_line_count, 12)}`));
        //.......................................................................................................
        whisper('Ω__12', "Prompt_file_reader::_populate_db", GUY.trm.white(`non-pre-matching line count:   –${U.format_nr(nonmatching_line_count, 12)}`));
        //.......................................................................................................
        whisper('Ω__13', "Prompt_file_reader::_populate_db", GUY.trm.white(`non-matching prompt count:     –${U.format_nr(this.prompt_parser.state.counts.non_matches, 12)}`));
        //.......................................................................................................
        return null;
      }
