(async function() {
  'use strict';
  var CRYPTO, DBay, FS, GUY, SQL, alert, debug, demo_exifreader, echo, help, id_from_text, info, inspect, log, nosuchprompt, plain, praise, prepare_db, reverse, rpr, set_path, urge, warn, whisper,
