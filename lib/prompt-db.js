(async function() {
  'use strict';
  var DATOM, DBay, GUY, Image_walker, Journal_walker, Prompt_db, SQL, U, alert, debug, echo, get_types, help, hide, info, inspect, lets, log, new_datom, plain, pluck, praise, reverse, rpr, stamp, trash, urge, warn, whisper;
  ...
  foreign key ( prompt_id ) references img_prompts ( id ) );`);
    ...
    prompt    text not null );`);
      //.......................................................................................................
      this.db(SQL`insert into img_prompts ( id, prompt ) values ( ?, ? );`, [U.id_from_text(U.nosuchprompt), U.nosuchprompt]);
      //.......................................................................................................
  ...
  ;`);
    ...
    img_get_known_path_ids() {
      var R, id, ref;
      R = new Set();
      ref = this.db.first_values(SQL`select id from img_files;`);
      for (id of ref) {
        R.add(id);
      }
      return R;
