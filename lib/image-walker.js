(async function() {
  'use strict';
  var DBay, FS, GUY, Image_iterator, SQL, U, alert, build_file_db, debug, echo, help, info, inspect, log, plain, praise, prepare_db, reverse, rpr, set_path, urge, warn, whisper,
  ...
  left join img_files   as f on ( f.prompt_id = p.id );`);
        ...
        db(SQL`create view rowcounts as
  ...
  //===========================================================================================================
  Image_iterator = class Image_iterator {
    //---------------------------------------------------------------------------------------------------------
