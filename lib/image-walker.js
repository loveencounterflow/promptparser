(async function() {
  'use strict';
  var DBay, FS, GUY, Image_walker, SQL, U, alert, build_file_db, debug, echo, help, info, inspect, log, plain, praise, prepare_db, reverse, rpr, set_path, urge, warn, whisper,
